...
export function MinimalistCanvas({ language, onClose }: MinimalistCanvasProps) {
  ...
  return (
    <div className="h-screen bg-background" dir="ltr">
        {/* Header */}
        <div className="p-3 border-b" dir={language === 'ar' ? 'rtl' : 'ltr'}>
                ...
                {nodeTemplates.map((template) => {
                  ...
                  return (
                    <div
                      ...
                      className="group p-3 bg-card border-2 border-dashed border-border hover:border-primary/50 rounded-xl cursor-grab active:cursor-grabbing transition-all duration-200 hover:bg-muted/50"
                    >
          ...
          >
            ...
            >
              ...
              {isDraggingFromSidebar && (
                ...
                >
                  <div className="w-full h-full rounded-2xl border-2 border-dashed border-primary/50 bg-primary/5 backdrop-blur-sm transition-all duration-200 flex items-center justify-center">
      ...
      <Dialog open={showConfigDialog} onOpenChange={setShowConfigDialog}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              {language === 'ar' ? 'قم بتعديل إعدادات هذه العقدة' : 'Configure the settings for this node'}
            </DialogDescription>
          </DialogHeader>
          {nodeToConfig && (
